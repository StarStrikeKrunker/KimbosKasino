...
local function Escape()
    ...
    -- Enable noclip for all body parts
    ...
    -- Use BodyPosition to physically move the character
    local bp = Instance.new("BodyPosition")
    bp.MaxForce = Vector3.new(math.huge, math.huge, math.huge)
    bp.D = 500
    bp.P = 5000
    bp.Position = escapePos + Vector3.new(0, 15, 0) -- Stay elevated
    ...
    if HumanoidRootPart then
        HumanoidRootPart.CFrame = CFrame.new(escapePos + Vector3.new(0, 15, 0))
        HumanoidRootPart.Anchored = true
    end
